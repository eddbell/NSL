...
sed -i "s/steps_dummy/$N/g" input.in
sed -i "s/nblk_dummy/$M/g" input.in

echo -e "<PARAMETERS INFO>"
echo -e "Steps =        $N"
echo -e "Blocks =       $M              (FIXED)"
echo -e "iD =           1               (FIXED)"
echo -e "iGS =          0               (FIXED)"
echo -e "delta =        0.8             (FIXED)"
...
mv output_rad.dat ./data/output_rad_equilibration.dat
mv output_pos.dat ./data/output_pos_equilibration.dat
echo "<INFO> Saving position output file in: ./data/output_rad_equilibration.dat"
echo "<INFO> Saving radius output file in:   ./data/output_pos_equilibration.dat"
echo -e "______________________________________________________________________\n\n"
