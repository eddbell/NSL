...
//Read input informations
  ...
  ReadInput >> delta;
  cout << "Value of metropoli step (delta) = "<< delta<<endl;
  ReadInput >> nblk;
...
// distance i-j in pbc
  ...
  walker[ip] = rho*walker[it] + (48.0/(3.0*vol)) * w; // pression
...
void PrintEq(int iblk){
  ...
  if(iblk%1000==0) cout<<iblk<< " of "<<nblk<<" blocks"<<setw(12)<<"rate : "<<accepted/attempted<<endl;
